...
#' <br>
#' When you are ready to make a post to your blog simply run `source('convert-R-to-post.R'` and `Post.to.blog('2018-07-19-my-file.R')`. The .md file sohuld automatically go to your `postdir` folder and images go to your `img` folder. Push this to Github and everything should post on your Jekyll github page. (**Note: filenames should have format of 'YYYY-MM-DD-filename.R' to work effectively with the Jekyll post format).
#' <br><br>
